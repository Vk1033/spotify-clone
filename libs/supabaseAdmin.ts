...
const createOrRetrieveCustomer = async ({ email, uuid }: { email: string; uuid: string }) => {
  ...
  if (error || !data?.stripe_customer_id) {
    ...
    console.log(`Customer ${uuid} upserted`);
    return customer.id;
  }
...
const manageSubscriptionChange = async (subscriptionId: string, customerId: string, createAction = false) => {
...
export { upsertProductRecord, upsertPriceRecord, createOrRetrieveCustomer, manageSubscriptionChange };
